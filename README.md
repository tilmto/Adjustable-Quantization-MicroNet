...
python eval.py --weight_bits 8 \
               ...
               --batch_size 50 \
               --bits_trainable \
               --ckpt_path best_ckpt/ckpt_0.17894_0.7500 \
