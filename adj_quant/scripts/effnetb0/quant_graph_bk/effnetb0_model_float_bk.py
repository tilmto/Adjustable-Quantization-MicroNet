    ...
    def _expanded_conv(self, net, cell_scope, strides=1):
        ...
        with tf.name_scope(cell_scope):
            with tf.name_scope("expand"):
                ...
                net = self._swish(net)
                net = self._cell_output(net, "identity", subscope='output_1')
            ...
            with tf.name_scope('se_1'):
                ...
                net_se = self._cell_output(net_se, "identity")
                net_se = self._swish(net_se)
                net_se = self._cell_output(net_se, "identity", subscope='output_1')
